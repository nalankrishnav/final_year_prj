...
from ga.fixed_eval import run_fixed_eval
    ...
    while True:
        ...
        for structure in structures:
            ...
            if structure.is_survivor:
                print(f'Robot {structure.label} survived, keeping score.')
            else:
                # Notice we removed 'args' and 'save_path_controller' because 
                # the Fixed Controller doesn't need neural network settings!
                fixed_args = (structure.body, structure.connections, env_name)
                group.add_job(run_fixed_eval, fixed_args, callback=structure.set_reward)
